...
from oidcmsg.client.oauth2.add_on import do_add_ons
from oidcmsg.client.oauth2.add_on.pkce import add_code_challenge
from oidcmsg.client.oauth2.add_on.pkce import add_code_verifier
...
class TestPKCE256:
    ...
    def create_client(self):
        config = {
            ...
            'add_ons': {
                "pkce": {
                    "function": "oidcmsg.client.oauth2.add_on.pkce.add_support",
                    "kwargs": {
