...
from oidcmsg.client.oidc.registration import add_callbacks
from oidcmsg.client.rp_handler import RPHandler
...
CLIENT_CONFIG = {
    "": {
        ...
        "services": {
            'web_finger': {
                'class': 'oidcmsg.client.oidc.webfinger.WebFinger'
            },
            "discovery": {
                'class': 'oidcmsg.client.oidc.provider_info_discovery'
                         '.ProviderInfoDiscovery'
            },
            'registration': {
                'class': 'oidcmsg.client.oidc.registration.Registration'
            },
            'authorization': {
                'class': 'oidcmsg.client.oidc.authorization.Authorization'
            },
            'access_token': {
                'class': 'oidcmsg.client.oidc.access_token.AccessToken'
            },
            'refresh_access_token': {
                'class': 'oidcmsg.client.oidc.refresh_access_token'
                         '.RefreshAccessToken'
            },
            'userinfo': {
                'class': 'oidcmsg.client.oidc.userinfo.UserInfo'
            }
        }
    },
    "linkedin": {
        ...
        'services': {
            ...
            'access_token': {
                'class': 'oidcmsg.client.provider.linkedin.AccessToken'
            },
            'userinfo': {
                'class': 'oidcmsg.client.provider.linkedin.UserInfo'
            }
        }
    },
    "facebook": {
    ...
    'github': {
        ...
        'services': {
            ...
            'refresh_access_token': {
                'class': 'oidcmsg.client.oidc.refresh_access_token.RefreshAccessToken'
            }
        }
    },
    'github2': {
...
def test_get_provider_specific_service():
    srv_desc = {
        'access_token': {
            'class': 'oidcmsg.client.provider.github.AccessToken'
        }
    }
