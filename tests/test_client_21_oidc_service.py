...
from oidcmsg.client.defaults import DEFAULT_OIDC_SERVICES
from oidcmsg.client.entity import Entity
from oidcmsg.client.exception import ParameterError
from oidcmsg.client.oidc.registration import add_jwks_uri_or_jwks
from oidcmsg.client.oidc.registration import response_types_to_grant_types
...
class TestCheckSession(object):
    ...
    def create_request(self):
        ...
        services = {
            "checksession": {
                'class': 'oidcmsg.client.oidc.check_session.CheckSession'
            }}
...
class TestCheckID(object):
    ...
    def create_request(self):
        ...
        services = {
            "checksession": {
                'class': 'oidcmsg.client.oidc.check_id.CheckID'
            }}
        entity = Entity(keyjar=CLI_KEY, config=client_config, services=services)
        entity.client_get("service_context").issuer = 'https://example.com'
...
class TestEndSession(object):
    ...
    def create_request(self):
        ...
        services = {
            "checksession": {
                'class': 'oidcmsg.client.oidc.end_session.EndSession'
            }}
        entity = Entity(keyjar=CLI_KEY, config=client_config, services=services)
        entity.client_get("service_context").issuer = 'https://example.com'
