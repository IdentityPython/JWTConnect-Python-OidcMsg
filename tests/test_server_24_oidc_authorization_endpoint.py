...
from oidcmsg.server.oauth2.authorization import authn_args_gather
from oidcmsg.server.oauth2.authorization import get_uri
from oidcmsg.server.oauth2.authorization import inputs
from oidcmsg.server.oauth2.authorization import join_query
from oidcmsg.server.oauth2.authorization import verify_uri
from oidcmsg.server.oidc import userinfo
from oidcmsg.server.oidc.authorization import Authorization
from oidcmsg.server.oidc.authorization import acr_claims
from oidcmsg.server.oidc.authorization import re_authenticate
from oidcmsg.server.oidc.provider_config import ProviderConfiguration
from oidcmsg.server.oidc.registration import Registration
...
class TestEndpoint(object):
    ...
    def test_do_request_user(self):
        ...
        endpoint_context.login_hint_lookup = init_service(
            {"class": "oidcmsg.server.login_hint.LoginHintLookup"}, None
        )
