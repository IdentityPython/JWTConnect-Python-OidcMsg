...
from oidcmsg.client.defaults import DEFAULT_OAUTH2_SERVICES
from oidcmsg.client.oauth2 import Client
...
class TestDPoPWithoutUserinfo:
    ...
    def create_client(self):
        config = {
            ...
            'add_ons': {
                "dpop": {
                    "function": "oidcmsg.client.oauth2.add_on.dpop.add_support",
                    "kwargs": {
...
class TestDPoPWithUserinfo:
    ...
    def create_client(self):
        ...
        services = {
            "discovery": {
                'class': 'oidcmsg.client.oauth2.provider_info_discovery.ProviderInfoDiscovery'
            },
            'authorization': {
                'class': 'oidcmsg.client.oauth2.authorization.Authorization'
            },
            'access_token': {
                'class': 'oidcmsg.client.oauth2.access_token.AccessToken'
            },
            'refresh_access_token': {
                'class': 'oidcmsg.client.oauth2.refresh_access_token.RefreshAccessToken'
            },
            'userinfo': {
