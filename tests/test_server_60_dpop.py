...
from oidcmsg.server.oauth2.add_on.dpop import DPoPProof
from oidcmsg.server.oauth2.add_on.dpop import post_parse_request
...
class TestEndpoint(object):
    ...
    def create_endpoint(self):
        conf = {
            ...
            "add_on": {
                "dpop": {
                    "function": "oidcmsg.server.oauth2.add_on.dpop.add_support",
                    "kwargs": {
